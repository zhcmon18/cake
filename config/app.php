...
return [
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' => 465,
            'username' => 'centreserivice@gmail.com',  //your gmail address
            'password' => 'cakeService2018',        //your gmail password
            'className' => 'Smtp',
            'log' => true,
            'context' => [
                'ssl' => [
    ...
    'Datasources' => [
        ...
        'test' => [
            ...
            'username' => 'root',
            'password' => 'secret',
            'database' => ROOT . DS . 'sqlite' . DS . 'centre_service_tests',
            //'encoding' => 'utf8mb4',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
