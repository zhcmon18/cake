...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'telephone' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-09-01 20:59:59',
                'modified' => '2018-09-01 20:59:59'
            ],
        ];
        parent::init();
    }
